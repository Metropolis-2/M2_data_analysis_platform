...
if __name__ == "__main__":
        ...
        choice = input("To generate dataframes enter 1, to generate graphs enter 2, to compute and print noise related statistics enter 3, to update the flst log enter 4 \n")
        choice = int(choice)
        if choice==1:
            ...
            now = datetime.now()
            current_time = now.strftime("%H:%M:%S")
            print("flst update started =", current_time)
            #m=MainClass(choice)
            dataframe_creator = DataframeCreator.DataframeCreator(choice)
            ...
            current_time = now.strftime("%H:%M:%S")
            print("flst update  ended =", current_time)               
