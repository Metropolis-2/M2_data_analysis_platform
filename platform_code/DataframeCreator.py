...
class DataframeCreator():
    ...
    def create_flstlog_dataframe(self):
        ...
        flstlog_data_frame=flstlog_data_frame.join(flint_data_frame,(flstlog_data_frame["ACID"]==flint_data_frame["ACID2"] ) & (flint_data_frame["scenario_name2"]==flstlog_data_frame["scenario_name2"]),"inner")# TODO: that shoudld be changed to outer
