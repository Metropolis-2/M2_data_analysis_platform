...
from schemas.tables_attributes import (ACID, FLST_ID, SCENARIO_NAME, RECEPTION_TIME, VEHICLE, DEPARTURE_TIME,
...
FP_INTENTION_FILE_SCHEMA = StructType([
...
FP_INTENTION_SCHEMA = StructType([
